...
- [ ] Reclamar y unificar fichas: Google Business x2 (cada una apuntando a su página), Yelp x2, consolidar las 2-3 páginas de Facebook. Evidencia del desorden: el horario de Facebook lleva ~1 año diciendo Lun-Vie 6:00-7:00 AM (una hora al día; claramente AM por PM) y Sáb-Dom hasta 11:45 PM. Corregirlo al reclamar. La web es la única fuente con datos completos y correctos.
